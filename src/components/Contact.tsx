...
export default function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 87 99116-8866",
      link: "https://wa.me/5587991168866?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "isaelc.bezerra@hotmail.com",
      link: "mailto:isaelc.bezerra@hotmail.com?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "Venturosa",
      description: "Campo Grande, 14",
      link: "https://goo.gl/maps/5Q8nqGHwuDYjzoq46",
