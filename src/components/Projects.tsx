...
export default function Projects() {
  const projects = [
    ...
    {
      title: "Simulador de Cadastro de Login",
  ...
  return (
    <>
      <section
        id="projects"
        className="rounded-tl-[80px] bg-gradient-to-tr from-black to-gray-900 text-white md:rounded-tl-[180px]"
      >
        <div className="container mx-auto max-w-4xl p-4 py-12">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            {projects.map((project, index) => (
              ...
              >
                <div
                  className={`absolute inset-0 flex h-full w-full flex-col items-center justify-center rounded-lg bg-blue-600 p-2 text-white opacity-0 transition-opacity group-hover:opacity-100`}
                >
